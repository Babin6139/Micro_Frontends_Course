...
export default function MiniCart(){
    ...
    return (
        <>
            ...
            {showCart &&(
                <>
                    <div className="absolute p-5 border-4 border-blue-500 bg-white rounded-xl text-black"
                        style={{
                            width:300,
                            top:"2rem",
                            left:-250
                    ...
                    >
                        ...
                        <div className="flex">
                            <div className="flex-grow">
                                <button
                                    id="clearcart"
                                    className="bg-white border border-green-800 text-sm text-green-800 py-2 px-5 rounded-md"
                                    onClick={clearCart}
                                >
                                    Clear Cart
                                </button>
